...
class LRP_LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LRP_LlamaConfig):
        ...
        self.o_proj = nn.Linear(self.num_heads * self.head_dim, self.hidden_size, bias=None)
        self._init_rope()
...
class LRP_LlamaModel(LRP_LlamaPreTrainedModel):
    ...
    def __init__(self, config: LRP_LlamaConfig):
        ...
        self.layers = nn.ModuleList([LRP_LlamaDecoderLayer(config) for _ in range(config.num_hidden_layers)])
